...
const { FiPlus, FiFilm, FiEdit3, FiCamera, FiFolder, FiLayers, FiVideo } = FiIcons;
...
const Dashboard = () => {
  ...
  const phases = [
    ...
    },
    {
      ...
      path: '/ideation', // Start from ideation to create a new project
      note: 'Create a project first'
    },
    {
      title: 'Shooting',
      ...
      >
        ...
        <motion.div className="text-center mb-12" variants={itemVariants}>
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Your complete filmmaking companion - from idea to final cut. Get guided through every step with smart prompts and professional workflows.
          </p>
        </motion.div>
        ...
        <motion.div className="mb-12" variants={itemVariants}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {phases.map((phase, index) => (
              <motion.div
                key={phase.title}
                className={`relative p-6 rounded-xl bg-gradient-to-br ${phase.color} cursor-pointer hover:scale-105 transition-all duration-300`}
              ...
              >
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    {phase.note && (
                      <span className="text-xs text-white/60">{phase.note}</span>
                    )}
                  </div>
                </div>
